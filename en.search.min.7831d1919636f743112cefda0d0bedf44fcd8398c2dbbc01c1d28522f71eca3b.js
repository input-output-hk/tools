...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/tools/flexsearch.min.js');loadScript('/tools/en.search-data.min.be9586ed08057a7c885acabae3fe5a2bd84326ddfc889c5b7bbc5ca9b0d0f13b.js',function(){input.required=false;search();});}
