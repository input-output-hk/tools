...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/tools/flexsearch.min.js');loadScript('/tools/en.search-data.min.a9edcb1c67c46fb807c30f55cbe2d06ff724a97a961410f06c9a6105e8832a47.js',function(){input.required=false;search();});}
